//////////////////////////////////////////////////////////////////////////////
function localSession($, socket, proxy){
    var state = 0, functions, agent = proxy();
    /*
...
module.exports = function($){
    return function(port, proxy){
        return new server($, port, proxy);
    };
};
